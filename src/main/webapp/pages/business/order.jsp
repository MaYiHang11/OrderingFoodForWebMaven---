...
10:47<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
...
<head>
    ...
    <style>
        @import url(../../css/business/order.css);
    </style>
</head>
<body>
...
<c:forEach var="order" items="${addOrder}"></c:forEach>
    ...
    <footer id="tabbar"class="tabbar">
        ...
        <div class="active">
            <img src="../../images/bar/order_active.png" /><br>
            订单
        </div>
        <div>
